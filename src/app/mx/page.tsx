...
const schema = {
  ...
  operatingSystem: "Web",
  description:
    "Sistema de reservas online con WhatsApp automático para barberías, salones de belleza, spas y consultorios en México.",
  url: "https://agenditapp.com/mx",
  offers: {
    "@type": "Offer",
    price: "380",
        ...
        <section className="py-16 px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl sm:text-3xl font-semibold text-heading text-center mb-3">
              Ideal para cualquier negocio de citas en México
            </h2>
        ...
        <section className="py-16 px-6 border-y border-brand/10" style={{ background: "color-mix(in srgb, var(--brand) 4%, transparent)" }}>
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-body text-center max-w-2xl mx-auto mb-8">
              En México, WhatsApp es el canal principal de comunicación con clientes.
        ...
        <section className="py-16 px-6">
          <div className="max-w-4xl mx-auto">
              ...
              {PLANS.map(({ name, price, desc, plan, featured }) => (
                ...
                >
                  ...
                  <p className={`text-3xl font-bold mt-1 ${featured ? "text-white" : "text-heading"}`}>
                    {price}
                    <span className={`text-sm font-normal ${featured ? "text-white/70" : "text-muted"}`}> MXN/mes</span>
                  </p>
            ...
            <p className="text-center text-xs text-muted mt-4">
              * Precios referenciales en MXN. Consulta precios actualizados en{" "}
        ...
        <section className="py-16 px-6 text-center">
          <div className="max-w-2xl mx-auto bg-bg-card border border-brand/10 rounded-[20px] p-10" style={{ boxShadow: "var(--shadow-card)" }}>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <DemoCtaButton source="landing_mx" className="inline-flex items-center justify-center rounded-[12px] border border-brand/20 text-brand font-medium px-8 py-3.5 text-[15px] hover:bg-brand/6 transition-colors cursor-pointer">
                Hablar con ventas
              </DemoCtaButton>
            </div>
          </div>
