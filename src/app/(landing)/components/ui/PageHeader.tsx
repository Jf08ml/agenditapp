      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <nav className="hidden lg:flex items-center gap-6">
            ...
            <Link href="/sectores" className="text-sm font-medium text-slate-300 hover:text-white transition-colors">
              Sectores
            </Link>
            <Link href="/funcionalidades" className="text-sm font-medium text-slate-300 hover:text-white transition-colors">
              Funcionalidades
            </Link>
        ...
        {mobileMenuOpen && (
          <nav className="lg:hidden py-4 border-t border-white/10 animate-in slide-in-from-top duration-200">
            <div className="flex flex-col gap-2">
              <Link
                href="/"
                className="text-sm font-medium text-slate-300 hover:text-sky-400 transition-all py-3 px-3 rounded-lg hover:bg-sky-400/10 active:scale-95"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-sm font-medium text-slate-400 hover:text-slate-200 transition-all py-3 px-3 rounded-lg hover:bg-white/5 active:scale-95"
                onClick={() => setMobileMenuOpen(false)}
              >
                👤 Registrarse
              </a>
