...
export const metadata: Metadata = {
  title: "Software de Agendamiento para Negocios en España",
  description:
    "Sistema de reservas online con WhatsApp automático para barberías, salones de belleza, spas y consultorios en España. Reservas 24/7. Prueba gratis sin tarjeta.",
  alternates: {
    canonical: "https://agenditapp.com/es",
    languages: HREFLANG_ALTERNATES,
  },
  openGraph: {
    title: "Software de Agendamiento para Negocios en España | AgenditApp",
    description:
      "Sistema de reservas online con WhatsApp automático para barberías, salones de belleza, spas y consultorios en España. Reservas 24/7. Prueba gratis sin tarjeta.",
    url: "https://agenditapp.com/es",
    locale: "es_ES",
    siteName: "AgenditApp",
  },
};
...
const schema = {
  ...
  operatingSystem: "Web",
  description:
    "Sistema de reservas online con WhatsApp automático para barberías, salones de belleza, spas y consultorios en España.",
  url: "https://agenditapp.com/es",
  offers: {
    "@type": "Offer",
    price: "19",
...
const SECTORS = [
  ...
  "Centros de fitness y entrenadores personales",
];
        ...
        <section className="py-16 px-6 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl font-semibold text-heading tracking-tight leading-tight mb-5">
              Sistema de agendamiento online para negocios en España
            </h1>
            <p className="text-lg text-body leading-relaxed max-w-2xl mx-auto mb-8">
              Miles de barberías, peluquerías y centros de estética en España gestionan sus
        ...
        <section className="py-16 px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl sm:text-3xl font-semibold text-heading text-center mb-3">
              Ideal para cualquier negocio de citas en España
            </h2>
        ...
        <section className="py-16 px-6 border-y border-brand/10" style={{ background: "color-mix(in srgb, var(--brand) 4%, transparent)" }}>
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-body text-center max-w-2xl mx-auto mb-8">
              En España, WhatsApp es el canal de comunicación más usado entre negocios y
              clientes. AgenditApp es la única plataforma de agendamiento que envía
              confirmaciones y recordatorios desde el número de WhatsApp Business de tu
              negocio — no desde un número genérico.
            </p>
        ...
        <section className="py-16 px-6">
          <div className="max-w-4xl mx-auto">
              ...
              {PLANS.map(({ name, price, desc, plan, featured }) => (
                ...
                >
                  ...
                  <p className={`text-3xl font-bold mt-1 ${featured ? "text-white" : "text-heading"}`}>
                    {price}
                    <span className={`text-sm font-normal ${featured ? "text-white/70" : "text-muted"}`}> EUR/mes</span>
                  </p>
            ...
            <p className="text-center text-xs text-muted mt-4">
              * Precios referenciales en EUR. Consulta precios actualizados en{" "}
        ...
        <section className="py-16 px-6 text-center">
          <div className="max-w-2xl mx-auto bg-bg-card border border-brand/10 rounded-[20px] p-10" style={{ boxShadow: "var(--shadow-card)" }}>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <DemoCtaButton source="landing_es" className="inline-flex items-center justify-center rounded-[12px] border border-brand/20 text-brand font-medium px-8 py-3.5 text-[15px] hover:bg-brand/6 transition-colors cursor-pointer">
                Hablar con ventas
              </DemoCtaButton>
            </div>
          </div>
