...
export const metadata: Metadata = {
  title: "Software de Agendamiento para Negocios en Costa Rica",
  description:
    "Sistema de reservas online con WhatsApp automático para barberías, salones de belleza, spas y consultorios en Costa Rica. Reservas 24/7. Prueba gratis sin tarjeta.",
  alternates: {
    canonical: "https://agenditapp.com/cr",
    languages: HREFLANG_ALTERNATES,
  },
  openGraph: {
    title: "Software de Agendamiento para Negocios en Costa Rica | AgenditApp",
    description:
      "Sistema de reservas online con WhatsApp automático para barberías, salones de belleza, spas y consultorios en Costa Rica. Reservas 24/7. Prueba gratis sin tarjeta.",
    url: "https://agenditapp.com/cr",
    locale: "es_CR",
    siteName: "AgenditApp",
  },
};
...
const schema = {
  ...
  operatingSystem: "Web",
  description:
    "Sistema de reservas online con WhatsApp automático para barberías, salones de belleza, spas y consultorios en Costa Rica.",
  url: "https://agenditapp.com/cr",
  offers: {
    "@type": "Offer",
    price: "20",
    ...
    <>
      ...
      <main className="min-h-screen pt-24">
        ...
        <section className="py-16 px-6 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-5xl font-semibold text-heading tracking-tight leading-tight mb-5">
              Sistema de agendamiento online para negocios en Costa Rica
            </h1>
            <p className="text-lg text-body leading-relaxed max-w-2xl mx-auto mb-8">
              Miles de barberías, salones de belleza y spas en Costa Rica manejan sus
        ...
        <section className="py-16 px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl sm:text-3xl font-semibold text-heading text-center mb-3">
              Ideal para cualquier negocio de citas en Costa Rica
            </h2>
        ...
        <section className="py-16 px-6 border-y border-brand/10" style={{ background: "color-mix(in srgb, var(--brand) 4%, transparent)" }}>
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-body text-center max-w-2xl mx-auto mb-8">
              En Costa Rica, WhatsApp es el canal principal de comunicación con clientes.
        ...
        <section className="py-16 px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-2xl sm:text-3xl font-semibold text-heading text-center mb-3">
              Planes disponibles en Costa Rica
            </h2>
            <p className="text-body text-center mb-8">
        ...
        <section className="py-16 px-6 text-center">
          <div className="max-w-2xl mx-auto bg-bg-card border border-brand/10 rounded-[20px] p-10" style={{ boxShadow: "var(--shadow-card)" }}>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              ...
              <DemoCtaButton source="landing_cr" className="inline-flex items-center justify-center rounded-[12px] border border-brand/20 text-brand font-medium px-8 py-3.5 text-[15px] hover:bg-brand/6 transition-colors cursor-pointer">
                Hablar con ventas
              </DemoCtaButton>
            </div>
          </div>
