...
export const sources: Record<string, ReferralSource> = {
  "felipe-blanco": {
    ...
    refCode:        "YA7M5EKJ",
    offerBase:      "1 mes gratis",
    offerBonus:     "Los primeros 5 en registrarse obtienen 2 meses gratis",
    bonusLimit:     5,
    photoUrl:       "/ref/felipe-blanco.jpg",
    quote:          "Panoch4 empecemos a recorrer un nuevo camino juntas",
    slotsTotal:     5,
    slotsRemaining: 3,
  },
  "vivehuila": {
    ...
    seoTitle:       "1 mes gratis en AgenditApp — Visto en Vivehuila",
    seoDescription: "Vivehuila te presenta AgenditApp: 1 mes completamente gratis para tu negocio de servicios en Huila. Agendamiento online, recordatorios por WhatsApp y gestión de clientes.",
